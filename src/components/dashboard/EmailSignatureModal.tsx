...
export function EmailSignatureModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div
        className={`${isLight ? 'bg-white border-gray-200' : 'bg-drone-surface border-gray-700'} border rounded-xl p-6 max-w-lg w-full mx-4 shadow-2xl max-h-[90vh] overflow-y-auto`}
      >
        {/* Header */}
